            ...
            {analysis.colorPalette?.length > 0 && (
              <div style={styles.palette}>
                ...
                {analysis.colorPalette.map((c, i) => (
                  <span key={i} style={styles.colorChip}>
                    {c}
                  </span>
                ))}
              </div>
    ...
    >
      <span
        style={{
          ...
          fontWeight: 500,
          color: "var(--accent2)",
          background: "rgba(126,147,184,0.1)",
          border: "1px solid rgba(126,147,184,0.2)",
          borderRadius: "4px",
          padding: "1px 6px",
        }}
      >
      ...
      {isLoading ? (
        ...
        <>
          ...
          <p style={styles.emptyHint}>
            Gemini will analyze its style, then generate a creative variation
          </p>
        </>
      )}
    </div>
...
const styles = {
  ...
  dropzoneDrag: {
    ...
    background: "rgba(126,147,184,0.07)",
  },
  dropzoneFilled: {
  ...
  btnAccent: {
    ...
    color: "var(--text)",
    border: "1px solid rgba(126,147,184,0.28)",
  },
