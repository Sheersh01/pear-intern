    ...
    <div style={styles.card} className="animate-fade-up">
      <div style={styles.imageWrap}>
        ...
        <div style={styles.overlay}>
          <a href={imageUrl} target="_blank" rel="noopener noreferrer" style={styles.overlayBtn}>
            <ExternalLink size={16} />
            Open
          </a>
          <a href={imageUrl} download="pearmedia-output.jpg" style={styles.overlayBtn}>
            <Download size={16} />
            Save
          </a>
        </div>
      ...
      {prompt && (
        <div style={styles.promptRow}>
          <p style={styles.promptText}>{prompt.slice(0, 120)}{prompt.length > 120 ? '…' : ''}</p>
