  ...
  return (
    <div style={styles.app}>
      ...
      <section style={styles.hero}>
        <div style={styles.heroInner}>
          <span style={styles.tag}>
            {activeTab === TABS.TEXT ? '✦ Workflow A — Text to Image' : '✦ Workflow B — Style Transfer'}
          </span>
          <h1 style={styles.heroTitle}>
            {activeTab === TABS.TEXT
              ? <>AI-Enhanced<br /><em>Creative Studio</em></>
              : <>Vision-Powered<br /><em>Style Lab</em></>
            }
          </h1>
      ...
      <main style={styles.main}>
        <div key={activeTab} className="animate-fade-up" style={styles.tabContent}>
      ...
      <footer style={styles.footer}>
        ...
        <span style={{ color: 'var(--muted)' }}>Built with Vite · React · Gemini · Pollinations</span>
        <a
          href="https://github.com/your-username/pearmedia-ai-prototype"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--text-dim)', textDecoration: 'none', fontFamily: 'var(--font-mono)', fontSize: '0.75rem' }}
        >
          GitHub ↗
        </a>
      </footer>
...
function ApiPill({ name, tag, color }) {
  return (
    <div style={{
      ...
      <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color, background: `${color}15`, borderRadius: '4px', padding: '1px 5px' }}>{tag}</span>
    </div>
  );
}
...
const styles = {
  ...
  hero: {
    ...
    background: `radial-gradient(ellipse 60% 80% at 20% 50%, rgba(184,255,87,0.04) 0%, transparent 70%)`,
  },
  ...
  heroTitle: {
    ...
    marginBottom: '0.75rem',
    background: 'linear-gradient(135deg, var(--text) 60%, var(--text-dim) 100%)',
  ...
  heroBadges: { display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'flex-end' },
  main: { flex: 1, padding: '2.5rem 2rem', maxWidth: '1400px', margin: '0 auto', width: '100%' },
  tabContent: {},
  footer: {
